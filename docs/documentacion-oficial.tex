...
% ─── Código fuente (listings puro, sin tcolorbox) ────────────
\usepackage{listings}
...
\lstnewenvironment{phpcode}[2][]
  {\lstset{style=phpstyle,caption={#2},#1}}
  {}
\lstnewenvironment{sqlcode}[2][]
  {\lstset{style=sqlstyle,caption={#2},#1}}
  {}
\lstnewenvironment{bashcode}[2][]
  {\lstset{style=bashstyle,caption={#2},#1}}
  {}
