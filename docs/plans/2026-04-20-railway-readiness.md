...
- [x] Completar S0-03 y S0-05.
- [x] Completar S1-01 a S1-06.
- [x] Completar S2-01 a S2-07.
...
- [x] Completar reglas de dominio Sprint 3.
- [x] Completar mejoras arquitectónicas Sprint 4.
- [x] Completar limpieza P3 Sprint 5.
...
- [x] `make dev` levanta app + db + redis + workers sin errores.
- [x] `make db-migrate` completa sin fallos.
- [x] Healthcheck `/health.php` responde OK.
- [x] Login mantiene sesión entre reinicios de app (Redis).
- [x] Uploads y facturas persisten tras redeploy (volume `/app/storage`).
- [x] Email links apuntan a dominio Railway real (no localhost).
