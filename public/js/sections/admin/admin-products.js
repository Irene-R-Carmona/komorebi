    ...
    Alpine.data('productManagement', (config = {}) => ({
      ...
      async toggleProductStatus(productId) {
        ...
        try {
          ...
          const response = await fetch(`/admin/menu/${productId}/toggle`, {
            method: 'POST',
            body: formData,
            headers: {
      ...
      async deleteProduct(productId, productName) {
        ...
        try {
          ...
          const response = await fetch(`/admin/menu/${productId}/delete`, {
            method: 'POST',
            body: formData,
            headers: {
              'X-Requested-With': 'XMLHttpRequest'
  ...
  window.ProductsTable = {
    ...
    async delete(productId, csrfToken) {
      ...
      try {
        ...
        const response = await fetch(`/admin/productos/${productId}/eliminar`, {
          method: 'POST',
          body: formData,
          headers: {
            'X-Requested-With': 'XMLHttpRequest'
    ...
    async toggleAvailability(productId, csrfToken, button) {
      ...
      try {
        ...
        const response = await fetch(`/admin/productos/${productId}/toggle`, {
          method: 'POST',
          body: formData,
          headers: {
            'X-Requested-With': 'XMLHttpRequest'
