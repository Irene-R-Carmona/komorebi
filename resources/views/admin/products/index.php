...
<div class="container-fluid" x-data='productActions(<?= $alpineConfig ?>)' x-cloak>
    ...
    <form method="GET" action="/admin/productos" class="filter-bar" x-data>
        <div class="filter-bar__row">
            ...
            <div class="filter-bar__actions">
                <a href="/admin/productos" class="btn btn-outline-secondary" title="Limpiar filtros">
