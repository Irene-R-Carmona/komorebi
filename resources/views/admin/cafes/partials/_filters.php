        ...
        <div class="filter-bar__filters">
            ...
            <div class="category-filters">
                ...
                <a href="<?= htmlspecialchars($mkUrl('category', 'lounge'), ENT_QUOTES, 'UTF-8') ?>"
                    ...
                    <span class="category-filter-btn__icon"><i class="bi bi-house-heart" aria-hidden="true"></i></span>Lounge
                </a>
                <a href="<?= htmlspecialchars($mkUrl('category', 'playroom'), ENT_QUOTES, 'UTF-8') ?>"
                    ...
                    <span class="category-filter-btn__icon"><i class="bi bi-controller" aria-hidden="true"></i></span>Playroom
                </a>
                <a href="<?= htmlspecialchars($mkUrl('category', 'farm'), ENT_QUOTES, 'UTF-8') ?>"
                    class="category-filter-btn<?= $currentCategory === 'farm' ? $active : '' ?>">
                    <span class="category-filter-btn__icon"><i class="bi bi-tree" aria-hidden="true"></i></span>Farm
                </a>
                <a href="<?= htmlspecialchars($mkUrl('category', 'zen'), ENT_QUOTES, 'UTF-8') ?>"
                    class="category-filter-btn<?= $currentCategory === 'zen' ? $active : '' ?>">
                    <span class="category-filter-btn__icon"><i class="bi bi-flower1" aria-hidden="true"></i></span>Zen
                </a>
            </div>
