...
final class RouteRegistrationTest extends TestCase
{
    ...
    // =========================================================================
    // F5 — Keeper AnimalCare: 4 rutas POST añadidas
    // =========================================================================

    public function testKeeperHasFeedingRoute(): void
    {
        $this->assertStringContainsString(
            "AnimalCareController@recordFeeding",
            $this->routesContent,
            'POST /keeper/animals/{id}/feeding debe apuntar a AnimalCareController@recordFeeding'
        );
    }

    public function testKeeperHasHealthActionRoute(): void
    {
        $this->assertStringContainsString(
            "AnimalCareController@recordHealth",
            $this->routesContent,
            'POST /keeper/animals/{id}/health debe apuntar a AnimalCareController@recordHealth'
        );
    }

    public function testKeeperHasPhotoRoute(): void
    {
        $this->assertStringContainsString(
            "KeeperApiController@uploadPhoto",
            $this->routesContent,
            'POST /api/v1/keeper/animals/{id}/photo debe apuntar a KeeperApiController@uploadPhoto'
        );
    }

    public function testKeeperHasCareLogRoute(): void
    {
        $this->assertStringContainsString(
            "KeeperApiController@createCareLog",
            $this->routesContent,
            'POST /api/v1/keeper/animals/{id}/care-log debe apuntar a KeeperApiController@createCareLog'
        );
    }

    // =========================================================================
    // F6 — HealthCheck edit/update + AnimalIncident edit/update
    // =========================================================================

    public function testHealthCheckHasEditRoute(): void
    {
        $this->assertStringContainsString(
            "HealthCheckController@edit",
            $this->routesContent,
            'GET /keeper/health-checks/{checkId}/edit debe apuntar a HealthCheckController@edit'
        );
    }

    public function testHealthCheckHasUpdateRoute(): void
    {
        $this->assertStringContainsString(
            "HealthCheckController@update",
            $this->routesContent,
            'POST /keeper/health-checks/{checkId} debe apuntar a HealthCheckController@update'
        );
    }

    public function testAnimalIncidentHasEditRoute(): void
    {
        $this->assertStringContainsString(
            "AnimalIncidentController@edit",
            $this->routesContent,
            'GET /keeper/incidents/{id}/edit debe apuntar a AnimalIncidentController@edit'
        );
    }

    public function testAnimalIncidentHasUpdateRoute(): void
    {
        $this->assertStringContainsString(
            "AnimalIncidentController@update",
            $this->routesContent,
            'POST /keeper/incidents/{id} debe apuntar a AnimalIncidentController@update'
        );
    }
}
