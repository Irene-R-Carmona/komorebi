...
final class DashboardController
{
    ...
    public function index(ServerRequestInterface $request): ?ResponseInterface
    {
        try {
            ...
            \header('Link: </css/sections/admin/admin-dashboard.css?v=' . Env::get('APP_VERSION', '1') . '>; rel=preload; as=style', false);
            \header('Link: </js/sections/admin/admin-dashboard.js?v=' . Env::get('APP_VERSION', '1') . '>; rel=preload; as=script', false);
